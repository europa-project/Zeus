...
unlocked to sign the Zeus-Qt.app bundle.
...
allowing somebody to distribute a Zeus-Qt.app or zeus-qt-setup.exe with a valid
...
that the zeus-qt.exe file inside the installer had not been tampered with.
