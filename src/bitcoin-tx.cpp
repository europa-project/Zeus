...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s zeus-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zeus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zeus transaction") + "\n" +
              "  zeus-tx [options] -create [commands]   " + _("Create hex-encoded zeus transaction") + "\n" +
              "\n";
